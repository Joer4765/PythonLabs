...
class SllGUI(tk.Toplevel):
    def __init__(self):
        super().__init__()
        self.title("SLL App")
        self.title("Singly Linked List GUI")
        ...
        self.data_label = tk.Label(self.ins, text='Literature list (for inserting):')
    ...
    def insert_at_pos(self):
        ...
        if data and pos:
            self.linked_list.insert_at_position(data, int(pos))
            self.data_entry.delete(0, 'end')
    ...
    def save_to_file(self):
        self.linked_list.save_to_file('sll.txt')
        messagebox.showinfo('', 'Saved successfully')

    def load_from_file(self):
        self.linked_list.load_from_file('sll.txt')
        self.display_list()
